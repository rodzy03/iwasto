                    ...
                    <div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url('{{asset('assets/media/bg/bg-8.jpg')}}')">
                        <div class="container">
                            ...
                            <div class="d-flex align-items-stretch text-center flex-column py-40">
                                ...
                                <h4 class="text-dark mb-12">To use the waste sorting guide, type the waste you would like to search and press Enter.<br>Scroll down to see its waste classification and a guide on how to properly segregate and dispose of this waste.</h4>
                                <!--end::Heading-->
                               <!--begin::Form-->
                            ...
                            if (len > 0) {
                                ...
                                for (var j = 0; j < len; j++) {
                                    ...
                                    if(s_type.toLowerCase() == "compostable / nabubulok" )
                                        ...
                                        src_type = "{{asset('image_types/metal')}}";
                                    else if (s_type.toLowerCase() == "recyclable / nareresiklo (glass)")
