                            ...
                            <div class="d-flex align-items-stretch text-center flex-column py-40">
                                ...
                                <form class="d-flex position-relative w-2 m-auto">
                                    <div class="input-group">
                                        ...
                                        <input class="typeahead form-control h-auto py-7 px-1;" id="search_swm" type="text" dir="ltr" placeholder="Search Waste" autocomplete="off" spellcheck="false" style="width:500px; border-radius: 0.20rem; font-size:large; color:#5e7a66">
